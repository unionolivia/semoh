...
@section('title', 'Add Extension')  <!-- change title accordingly-->
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form-group col-6" method="POST" action="/addext">
                        ...
                        <input type="text" class="form-control" id="extname" name="extname" placeholder="Enter Name" value="{{ old('extname')}}">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="extlocation" name="extlocation" placeholder="Enter Address" value="{{ old('extlocation')}}">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="extsmr" name="extsmr" placeholder="Enter representatives name" value="{{ old('extsmr')}}">
