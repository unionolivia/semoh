            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form action="/members" method="post" class="number-tab-steps wizard-circle" enctype="multipart/form-data">
                            @csrf
                            ...
                            <fieldset>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="firstName1" name="firstName1" value="{{ old('firstName1')}}">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="emailAddress1" value="{{ old('emailAddress1')}}">
                                        </div>
                                    </div>
                                </div> 
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                                ...
                                                <input type="text" class="form-control pickadate-months-year" name="dateofBirth1" id="dateofBirth1">
                                         </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="pictureFile">Upload picture</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select form-control" id="parentMaritalStatus" name="parentMaritalStatus">
                                                <option value="new-york">single</option>
                                                <option value="chicago">married</option>
                                                <option value="san-francisco">seperated</option>
                                                <option value="boston">Divorced</option>
                                            </select>
                                        </div>                                        
                                      </div>
                                 </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select form-control" id="ministry1" name="ministry1">
                                                <option value="">Select</option>
                                                <option value="Banquet">Evangelism</option>
                                                <option value="Fund Raiser">Choir</option>
                                                <option value="Dinner Party">Pastor's Protocol</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select form-control" id="eventType1" name="eventType1">
                                                <option value="">Select</option>
                                                <option value="Banquet">Business School</option>
                                                <option value="Fund Raiser">Software</option>
                                                <option value="Dinner Party">Kitchen</option>
                                            </select>
                                        </div>
                                    </div>                                    
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select form-control" id="extension" name="extension">
                                                <option value="">Select</option>
                                                <option value="new-york">Lekki</option>
                                                <option value="chicago">Akure</option>
                                                <option value="san-francisco">Ikeja</option>
                                                <option value="boston">Ile-ife</option>
                                            </select>
                                        </div>
