...
<section id="component-swiper-autoplay">
  <div class="card ">
    <div class="card-header">
      <h4 class="card-title">Welcome Mr. Smith</h4>
    </div>
    <div class="card-content">
      <div class="card-body">
        <div class="swiper-autoplay swiper-container">
          <div class="swiper-wrapper">
            <div class="swiper-slide"> <img class="img-fluid" src="https://pixinvent.com/demo/vuexy-html-bootstrap-admin-template/app-assets/images/banner/banner-7.jpg" alt="banner">
            </div>
            <div class="swiper-slide"> <img class="img-fluid" src="https://pixinvent.com/demo/vuexy-html-bootstrap-admin-template/app-assets/images/banner/banner-8.jpg" alt="banner">
            </div> 
          </div>
          <!-- Add Pagination -->
      ...
      <div class="card bg-analytics text-white">
        <div class="card-content">
          <div class="card-body text-center">
            <img src="../images/elements/decore-left.png" class="img-left" alt="
            card-img-left">
            <img src="../images/elements/decore-right.png" class="img-right" alt="
            card-img-right">
      ...
      <div class="col-lg-3 col-md-6 col-12">
        <div class="card">
            <div class="card-header d-flex flex-column align-items-start pb-0">
                ...
                <p class="mb-0">Required Subscribers</p>
            </div>
            <div class="card-content">
          ...
          <div class="card-content">
              <div class="card-body">
                  ...
                  <div class="row avg-sessions pt-50">
                      ...
                      <div class="col-6">
                          <p class="mb-0">Retrun on Investment: 17.5%</p>
                          <div class="progress progress-bar-danger mt-25">
                            <div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="70" aria-valuemax="100"
                              style="width:70%"></div>
                          </div>
...
@push('scripts')
    <link rel="stylesheet" type="text/css" href="vendors/css/extensions/swiper.min.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('css/plugins/extensions/swiper.min.css') }}">
    <script src="vendors/js/extensions/swiper.min.js"></script>
    <script src="{{ asset('js/scripts/extensions/swiper.min.js') }}"></script>
@endpush